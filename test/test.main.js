...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a standard normal distribution using the Improved Ziggurat algorithm (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
